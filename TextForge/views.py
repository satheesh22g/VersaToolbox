...
def generate_profile(request):
    ...
    if request.method == "POST":
        print(2)
        profile_fake = (
            Faker("en_IN") if request.POST.get("profileType") == "indian" else Faker()
        )
        profile = {
            ...
            "favorite_movie": profile_fake.random_element(
                elements=(
            ...
            "favorite_food": profile_fake.random_element(
                elements=("Pizza", "Sushi", "Chocolate", "Burgers")
            ),
            "blood_group": profile_fake.random_element(
            ...
            "education": profile_fake.random_element(
                elements=("High School", "Bachelor's Degree", "Master's Degree", "PhD")
            ),
            "religion": profile_fake.random_element(
                elements=(
                    "Christianity",
                    "Islam",
                    "Hinduism",
            ...
            "political_views": profile_fake.random_element(
                elements=(
                    "Conservative",
                    "Liberal",
                    "Moderate",
