...
from .models import CustomUser, ErrorReport, Feedback
...
def user_login(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            if user.has_usable_password() and check_password(
                "dummy_password", user.password
            ):
    ...
    if request.method == "POST":
        ...
        if action == "create_user":
            ...
            password = request.POST.get(
                "password"
            )  # You may want to validate and hash the password
...
def view_reports(request):
    ...
    return render(
        request,
        "view_reports.html",
        {"feedbacks": feedbacks, "error_reports": error_reports},
    )
